...
public class PaymentRepositoryTest {
    ...
    void testFindAll() {
        ...
        Payment payment1 = new Payment("8b290f4f-26d0-4eb2-b78b-dd83474fe451", PaymentMethod.BANK_TRANSFER.getValue(), paymentData);
        paymentRepository.save(payment1);

        HashMap<String, String> paymentData = new HashMap<>();
        paymentData.put("voucherCode", "ESHOP19238FFF331");
        Payment payment2 = new Payment("d706d686-2597-4a82-b107-6564785c675b", PaymentMethod.VOUCHER_CODE.getValue(), paymentData);
